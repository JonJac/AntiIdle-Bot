...
public class GregClassifier {
    ...
    public static final Set<Integer> stuffToClick = Set.of(2,3,4,5);

    private static final String RESOURCES_FOLDER_PATH = "greg";

    private static final int HEIGHT = 40;
    private static final int WIDTH = 40;

    private static int N_SAMPLES_TRAINING = 4257;
    private static int N_SAMPLES_TESTING = 4257;
