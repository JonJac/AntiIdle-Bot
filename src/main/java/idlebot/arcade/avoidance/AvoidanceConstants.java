...
public class AvoidanceConstants {
    ...
    static final int searchLength = 20;
    static final int padding = 70;
    static final int searchGridDistY = (gameWindow.height - 2 * padding) / 4 - 1;
    static final int searchGridDistX = (gameWindow.width - 2 * padding) / 6 - 1;
