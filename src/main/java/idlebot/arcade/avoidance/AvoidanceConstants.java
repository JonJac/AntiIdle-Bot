...
public class AvoidanceConstants {
    ...
    static final int searchLength = 250;
    static final int padding = 50;
    static final int searchGridDistY = (gameWindow.height - padding * 2) / 2 - 1;
    static final int searchGridDistX = (gameWindow.width - padding * 2) / 1 - 1;
